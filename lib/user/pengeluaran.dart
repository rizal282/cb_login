...
class _PengeluaranState extends State<Pengeluaran> {
  ...
  void getPengeluaran() async {
    var response = await http.get("http://192.168.43.171/cb-login/user/pengeluaran");
  ...
  void _hapusPengeluaran(String id) async {
    await http.post("http://192.168.43.171/cb-login/user/hapusPengeluaran", body: {
      "id" : id
    });
  ...
  void _cetakPdf(context) async {
    var data = await http.get("http://192.168.43.171/cb-login/user/pengeluaran"); 
